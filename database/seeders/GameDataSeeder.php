...
class GameDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('fish_species')->insertOrIgnore([
            ...
            ['name' => 'Ilek', 'category' => 'Oyod', 'difficulty' => 5, 'card_count' => 2, 'art' => json_encode(['shape' => 'oval', 'body' => '#b8a94c', 'belly' => '#e6dfa8', 'acc' => '#6f6524', 'pat' => 'spots']), 'sort' => 18, 'created_at' => $now, 'updated_at' => $now],
            ['name' => 'Arawa', 'category' => 'Oyod', 'difficulty' => 5, 'card_count' => 2, 'art' => json_encode(['shape' => 'long', 'body' => '#c0ccd4', 'belly' => '#f0f4f7', 'acc' => '#607a88', 'pat' => 'hline']), 'sort' => 19, 'created_at' => $now, 'updated_at' => $now],
        ]);
